...
Window_ActorCommand.prototype.addSkillCommands = function() {
    //var skillTypes = this._actor.addedSkillTypes();
    //console.log(this._actor.skills())
    //skillTypes.sort(function(a, b){return a-b});
    //skillTypes.forEach(function(stypeId) {
    //    var name = 'ああ'//$dataSystem.skillTypes[stypeId];
    //    this.addCommand(name, 'skill', true, stypeId);
    //}, this);
    if (this._actor.skills()[0]){
        //console.log(this._actor.skills()[0])
        this.addCommand(this._actor.skills()[0].id, 'skill', true, this._actor.skills()[0].id);
    }
    if (this._actor.skills()[1]){
        //console.log(this._actor.skills()[1])
        this.addCommand(this._actor.skills()[1].id, 'skill', true, this._actor.skills()[1].id);
    }
};
